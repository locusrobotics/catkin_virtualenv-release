## catkin_virtualenv (kinetic) - 0.6.1-1

The packages in the `catkin_virtualenv` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -r kinetic -t kinetic catkin_virtualenv --edit` on `Mon, 24 Aug 2020 21:15:40 -0000`
...
## catkin_virtualenv (melodic) - 0.6.1-1

The packages in the `catkin_virtualenv` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic catkin_virtualenv --edit` on `Mon, 24 Aug 2020 21:13:53 -0000`
...
## catkin_virtualenv (noetic) - 0.6.1-1

The packages in the `catkin_virtualenv` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic catkin_virtualenv --edit` on `Mon, 24 Aug 2020 21:12:25 -0000`
...
## catkin_virtualenv (noetic) - 0.6.0-1

The packages in the `catkin_virtualenv` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic catkin_virtualenv` on `Tue, 14 Jul 2020 16:49:40 -0000`
...
## catkin_virtualenv (kinetic) - 0.5.2-1

The packages in the `catkin_virtualenv` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -r kinetic -t kinetic catkin_virtualenv --edit` on `Mon, 06 Apr 2020 16:20:16 -0000`
...
## catkin_virtualenv (kinetic) - 0.5.0-1

The packages in the `catkin_virtualenv` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -r kinetic -t kinetic catkin_virtualenv --edit` on `Mon, 06 Apr 2020 16:18:25 -0000`
...
## catkin_virtualenv (melodic) - 0.5.0-2

The packages in the `catkin_virtualenv` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic catkin_virtualenv` on `Mon, 16 Sep 2019 16:01:56 -0000`
...
## catkin_virtualenv (melodic) - 0.5.0-1

The packages in the `catkin_virtualenv` repository were released into the `melodic` distro by running `/usr/bin/bloom-release catkin_virtualenv -r melodic -t melodic --edit` on `Fri, 30 Aug 2019 13:03:46 -0000`
...
## catkin_virtualenv (kinetic) - 0.4.1-2

The packages in the `catkin_virtualenv` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -r kinetic -t kinetic catkin_virtualenv` on `Thu, 13 Jun 2019 12:27:54 -0000`
...
## catkin_virtualenv (kinetic) - 0.4.1-1

The packages in the `catkin_virtualenv` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -r kinetic -t kinetic catkin_virtualenv` on `Tue, 11 Jun 2019 21:15:54 -0000`
...
## catkin_virtualenv (melodic) - 0.4.1-1

The packages in the `catkin_virtualenv` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic catkin_virtualenv` on `Tue, 11 Jun 2019 20:51:53 -0000`
...
## catkin_virtualenv (melodic) - 0.4.0-0

The packages in the `catkin_virtualenv` repository were released into the `melodic` distro by running `/usr/bin/bloom-release catkin_virtualenv -r melodic -t melodic` on `Mon, 18 Mar 2019 17:43:12 -0000`
...
## catkin_virtualenv (melodic) - 0.2.2-0

The packages in the `catkin_virtualenv` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic catkin_virtualenv` on `Thu, 06 Dec 2018 18:42:53 -0000`
...
## catkin_virtualenv (lunar) - 0.2.0-0

The packages in the `catkin_virtualenv` repository were released into the `lunar` distro by running `/usr/local/bin/bloom-release -r lunar -t lunar catkin_virtualenv` on `Thu, 03 May 2018 23:55:24 -0000`
